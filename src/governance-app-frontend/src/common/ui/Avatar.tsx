...
export const Avatar = ({
    ...
    return (
        <div className={cn("relative inline-block", className)}>
            ...
            {status && (
                <span className={cn(
                    "absolute bottom-0 right-0 block size-2.5 rounded-full ring-2 ring-white transform translate-x-1/4 translate-y-1/4",
            ...
            {verified && (
                <span className="absolute bottom-0 right-0 block size-3.5 bg-blue-500 rounded-full text-white ring-2 ring-white flex items-center justify-center transform translate-x-1/4 translate-y-1/4">
