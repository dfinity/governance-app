...
export const BottomNav = () => {
  ...
  return (
    <nav
      className={
        pwa
          ? 'fixed right-0 bottom-0 left-0 z-50 border-t border-t-amber-500 bg-amber-500/30 pb-[env(safe-area-inset-bottom)] shadow-[0_-3px_12px_rgba(0,0,0,0.08),0_-1px_3px_rgba(0,0,0,0.04)] backdrop-blur-lg lg:hidden'
