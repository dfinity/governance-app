...
export const CANISTER_ID_NNS_DAPP = process.env.CANISTER_ID_NNS_DAPP;
export const CANISTER_ID_SPAM_FILTER = process.env.CANISTER_ID_SPAM_FILTER;
export const CANISTER_ID_SELF = process.env.CANISTER_ID_SELF;
