...
- Set it as "public" in [GHCR](https://github.com/orgs/dfinity/packages/container/package/governance-app%2Fbuilder-base) so that everyone can download and use it to verify builds (one-off).
